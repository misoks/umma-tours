 ...
 */
function custommobile_html_head_alter(&$head_elements) {
 ...
 */
function custommobile_breadcrumb($variables) {
 ...
 */
function custommobile_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function custommobile_preprocess_node(&$variables) {
 ...
 */
function custommobile_preprocess_region(&$variables, $hook) {
 ...
 */
function custommobile_preprocess_block(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function custommobile_process_block(&$variables, $hook) {
